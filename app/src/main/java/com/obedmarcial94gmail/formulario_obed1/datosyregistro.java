package com.obedmarcial94gmail.formulario_obed1;
...
public class datosyregistro extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datosyregistro);
   ...
   /* public void Onclick (View view) {
    ...
    public void onClick(View v) {
        if (v == modificar) {
            ...
            Intent explicit_intent;
            explicit_intent = new Intent(this, confirmacion.class);
            startActivity(explicit_intent);
        }
